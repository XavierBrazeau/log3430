...
class TestACGraphGeneratorTest {
	...
	//Method tested: eulerianCycle
		//Case: <{V: v = 1. E: e = 1}, {Graph with eulerian cycle}>
		@Test
		...
		//Case: <{V: v > 1. E: e = 1}, {Graph with eulerian cycle}>
		@Test
		void acceptVerticesSingleEdgeEulerian() {
			vertex1 = 4;
			edges = 1;
			Graph graph = GraphGenerator.eulerianCycle(vertex1, edges);
			assertAll("Graph with eulerian cycle",
		...
		//Case: <{V: v = 1. E: e > 1}, {Graph with eulerian cycle}>
		@Test
		void acceptSingleVertexManyEdgesEulerian() {
			vertex1 = 1;
			edges = 4;
			Graph graph = GraphGenerator.eulerianCycle(vertex1, edges);
			assertAll("Graph with eulerian cycle",
	...
	//Case: <{V: v > 1. E: e > 1}, {Graph with eulerian cycle}>
	@Test
	void acceptVerticesManyEdgesEulerian() {
		vertex1 = 4;
		edges = 4;
		Graph graph = GraphGenerator.eulerianCycle(vertex1, edges);
		assertAll("Graph with eulerian cycle",
 ...
 *****************************************************************************************************************************/
	...
	//Method tested: bipartite
		...
		//Case: <{V1: v = 1, V2: v = 1, E: e = 0}, {Bipartite graph}>
			@Test
		void acceptNoEdgeNoVerticesBipartite() {
			vertex1 = 0;
			vertex2 = 0;
			edges = 0;
		...
		//Case: <{V1: v = 1, V2: v = 1, E: e = 0}, {Bipartite graph}>
		@Test
		void rejectEdgesNoVertices2Bipartite() {
			vertex1 = 2;
			vertex2 = 0;
			edges = 1;
			assertThrows(IllegalArgumentException.class, () -> GraphGenerator.bipartite(vertex1, vertex2, edges), "L'erreur n'a pas été lancée.");
		...
		//Case: <{V1: v = 1, V2: v = 1, E: e = 0}, {Bipartite graph}>
		@Test
		void rejectEdgesNoVertices1Bipartite() {
			vertex1 = 0;
			vertex2 = 2;
			edges = 1;
			assertThrows(IllegalArgumentException.class, () -> GraphGenerator.bipartite(vertex1, vertex2, edges), "L'erreur n'a pas été lancée.");
		...
		//Case: <{V1: v = 1, V2: v = 1, E: e = 0}, {Bipartite graph}>
			@Test
		void acceptManyVertices1ZeroVertex2NoEdgeBipartite() {
			vertex1 = 2;
			vertex2 = 0;
			edges = 0;
			Graph graph = GraphGenerator.bipartite(vertex1, vertex2, edges);
		...
		//Case: <{V1: v = 1, V2: v = 1, E: e = 0}, {Bipartite graph}>
			@Test
		void acceptManyVertices2ZeroVertex1NoEdgeBipartite() {
			vertex1 = 0;
			vertex2 = 2;
			edges = 0;
			Graph graph = GraphGenerator.bipartite(vertex1, vertex2, edges);
 ...
 *****************************************************************************************************************************/	
		...
		//Method tested: regular
		//Case: <{V: V*k pair && V > k + 1, k: k = 0}, {regular graph}>
		@Test
		void acceptZeroDegreeZeroVertexRegular() {
			vertex1 = 0;
			k = 0;
		...
		//Method tested: regular
		//Case: <{V: V*k pair && V = k + 1, k: k = 2}, {regular graph}>
		@Test
		void acceptPositiveDegreePositiveVertexRegular() {
			vertex1 = 3;
			k = 2;
			Graph graph = GraphGenerator.regular(vertex1, k);
			assertAll("Graph regular",
		...
		@Test
		void acceptZeroDegreePositiveVertexRegular() {
			vertex1 = 2;
			k = 0;
			Graph graph = GraphGenerator.regular(vertex1, k);
			assertAll("Graph regular",
		...
		@Test
		void acceptpositiveDegreeZeroVertexRegular() {
			vertex1 = 3;
			k = 1;
			Graph graph = GraphGenerator.regular(vertex1, k);
			assertAll("Graph regular",
